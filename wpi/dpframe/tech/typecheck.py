...
class Checker(object):
    ...
    def create(value): # static factory method
        # print(7547, value)
        # print(564634,Checker._registered)
        for f, t in Checker._registered:
            # print('f- ',f ,'t-',t)
            # print('f',f,'value5',value)
            # print(54545, f(value))
            # print(5656, type(f))
            if f(value):
                return t(value)
...
# print(979867855, Checker._registered, TypeChecker)
Checker._registered.append((isclass, TypeChecker))
print(979867856, Checker._registered)
...
class DictOfChecker(Checker):
    ...
    def check(self, value):
        return isinstance(value, dict) and \
               not filter(lambda e: not self.key_reference.check(e),  iter(value)) and \
...
int_type = (int)
num_type = (int_type, float, complex)
env_type = dict_of(str, anything)

################################################################################
# EOF
## end of http://code.activestate.com/recipes/426123/ }}}
