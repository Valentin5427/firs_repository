...
a = Analysis([os.path.join(HOMEPATH,'support/_mountzlib.py'), 
				...
				os.path.join(ROOT_PATH, 'electrolab/gui/utility1.py'),
				],
             pathex=[ROOT_PATH],
             hookspath=[os.path.join(SPECPATH, 'hooks/utility1')]
            )
...
exe = EXE(pyz,
          a.scripts,
          exclude_binaries=1,
          name=os.path.join('build/pyi.win32/workplacetester', 'utility1.exe'),
          debug=False,
          strip=False,
          upx=True,
