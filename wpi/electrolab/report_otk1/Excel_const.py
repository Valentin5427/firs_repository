...
#xlDownward = -4170 #Der Text verläuft abwärts.
#xlHorizontal =-4128 # Der Text verläuft horizontal.
#xlUpward =-4171 # Der Text verläuft aufwärts.
#xlVertical = -4166 #Der Text verläuft abwärts und ist in der Zelle zentriert.
