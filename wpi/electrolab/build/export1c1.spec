...
a = Analysis([os.path.join(HOMEPATH,'support/_mountzlib.py'), 
				...
				os.path.join(ROOT_PATH, 'electrolab/app/export1c.py'),
				],
             pathex=[ROOT_PATH],
             hookspath=[os.path.join(SPECPATH, 'hooks/export1c')]
            )
...
exe = EXE(pyz,
          a.scripts,
          exclude_binaries=1,
          name=os.path.join('build/pyi.win32/export1c', 'export1c.exe'),
          debug=False,
          strip=False,
          upx=True,
