...
a = Analysis([
				...
				os.path.join(ROOT_PATH, 'electrolab/gui/workplacemanager.py'),
				],
             pathex=[ROOT_PATH],
             hookspath=[os.path.join(SPECPATH, 'hooks/wpm')]
            )
...
exe = EXE(pyz,
          a.scripts,
          exclude_binaries=1,
          name=os.path.join('build/pyi.win32/workplacemanager', 'wpm.exe'),
          debug=False,
          strip=False,
          upx=False,
          icon='../gui/ui/ico/Manager.ico',
          console=False )
