...
a = Analysis([os.path.join(HOMEPATH,'support/_mountzlib.py'), 
				...
				os.path.join(ROOT_PATH, 'electrolab/gui/TestHeart.py'),
				],
             pathex=[ROOT_PATH],
             hookspath=[os.path.join(SPECPATH, 'hooks/TestHeart')]
            )
...
exe = EXE(pyz,
          a.scripts,
          exclude_binaries=1,
          name=os.path.join('build/pyi.win32/TestHeart', 'TestHeart.exe'),
          debug=False,
          strip=False,
          upx=True,
          console=False )
